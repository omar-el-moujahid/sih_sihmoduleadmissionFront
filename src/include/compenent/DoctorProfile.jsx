    ...
    const handelchange =async (e) =>{
        ...
        if(oldpasswordref.current.value==="" ||oldpasswordref.current.value==="" )  seterrorpasword("Non of fields should be empty")
            ...
            try {
                seterrorsbackend("")
                setCustomError("")
                const response = await axios.post("http://localhost:8080/doctor/Updatepassword", null, {
                    params: {
                        CIN: user.cne,
                                        ...
                                        <div className="">
                                            ...
                                            <form className="">
                                                ...
                                                <div className="row mt-3">
                                                    ...
                                                    <div className="col">
                                                        <label htmlFor="adress"
                                                               className={'form-label'}> office nomber </label>
                                                        <input type="text" className="form-control"
                                                               placeholder={user.offecNomber}
                                                               ref={adressref}
                                                        />
                                                    </div>
                                                </div>
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="special-heading-Medicale-hisriry ">
                                <h5 className={'ms-2'}> Today s Appointment
                                </h5>
                            </div>
                        </div>
                    </div>
